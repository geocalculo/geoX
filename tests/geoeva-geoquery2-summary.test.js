...
const actual = context.window.GeoQueryRender.summary({
  approvedInvestment: 100,
  dominantSector: "Energía",
  dominantSectorInvestment: 63,
  dominantSectorInvestmentShare: 63,
  base: new Array(10),
  radiusMeters: 52810,
  total: 13,
...
assert.equal(actual, "El clúster de análisis concentra una inversión aprobada de US$ 100,00 MM, de los cuales el sector Energía aporta US$ 63,00 MM, equivalentes al 63 % de la inversión aprobada, consolidándose como la actividad predominante del entorno. El grupo base está conformado por los 10 proyectos aprobados más cercanos, que definen un radio de análisis de 52,81 km, dentro del cual se registran 13 proyectos sometidos al Sistema de Evaluación de Impacto Ambiental. El proyecto aprobado más cercano se localiza a 23,71 km del punto consultado.");
